        ...
        foreach ($employes as $employe) {
            echo <<<EOT
                <tr>
                    ...
                    <td>
                        <a class="modifier" href="employe.php?id={$employe['id']}" title="Modifier l'employé">
                            <i class="fas fa-user-edit"></i>
                        </a>
                    </td>
                    <td>
                        <a class="supprimer" disabled="true" href="supprimer.php?id={$employe['id']}" title="Supprimer l'employé">
                            <i class="fas fa-user-times"></i>
                        </a>
                    </td>
                    <td>
                        <a class="detail" href="details.php?id={$employe['id']}" title="Voir les détails de l'employé">
